...
# x_train=np.reshape(x_train,(x_train.shape[0], 1723, 2, 1))
# x_test=np.reshape(x_test,(x_test.shape[0], 1723, 2, 1))
...
model.add(Conv1D(64,kernel_size=5,strides=1 ,input_shape=(32,32)))
...
history = model.fit(x_train,y_train,batch_size=64,epochs=90,validation_data=(x_test,y_test))
